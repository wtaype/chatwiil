import{j as e}from"./vendor-gzd0YkcT.js";import{v as s,a,l as i,b as c,c as o}from"./wii-BArvJV_J.js";import{e as d}from"./main-Bf8DocAo.js";import"./main-CJcK61zC.js";const p=()=>`
  <div class="acerca_container">
    <div class="acerca_hero">
      ...
      <div class="hero_logo">
        <img src="/smile.avif" alt="${a}" style="width: 120px; height: 120px; border-radius: 50%; object-fit: cover; box-shadow: 0 8px 30px rgba(0,0,0,0.2);">
      </div>
    ...
    <div class="acerca_section">
      ...
      <div class="section_content">
        <p><strong>${a}</strong> es un asistente espiritual inteligente diseñado con <strong>11 módulos neuronales especializados</strong>. Lanzado en ${i}, nace con la misión de ofrecer ayuda espiritual, matemática, emocional y técnica en un solo lugar.</p>
        <p>Con módulos dedicados para <strong>fe, matemáticas, programación, consejos de vida, creatividad y más</strong>, ${a} procesa tus preguntas con inteligencia contextual y te responde con empatía, sabiduría bíblica y precisión técnica.</p>
    ...
    <div class="acerca_section">
      <h2 class="section_title">
        <i class="fas fa-cogs"></i> ¿Cómo Funciona el Cerebro de ${a}?
      </h2>
    ...
    <div class="acerca_section">
      ...
      <div class="version_timeline">
        ...
        <div class="version_item">
          <div class="version_badge current">v${s}</div>
          <div class="version_content">
            <h3>Versión ${s} - Actualización Mayor 🚀</h3>
      ...
      <div class="roadmap_content">
        <div class="roadmap_item">
          ...
          <div class="roadmap_info">
            ...
            <p>Habla con ${a} usando tu voz y recibe respuestas en audio</p>
          </div>
        </div>
        <div class="roadmap_item">
          <div class="roadmap_icon planned">
      ...
      <div class="developer_card">
        ...
        <div class="developer_info">
          ...
          <p class="developer_bio">
            ...
            ${a} nace del deseo de combinar inteligencia artificial con espiritualidad cristiana.
          </p>
    ...
    <div class="acerca_footer">
      ...
      <div class="footer_info">
        <p>© ${i} ${a}. Hecho con <i class="fas fa-heart"></i> y <i class="fas fa-praying-hands"></i> por ${c}</p>
        <p class="footer_version">Versión actual: <strong>${s}</strong></p>
      </div>
    </div>
  </div>
`,f=()=>{e(".copy_email").on("click",function(){const l=e(this).data("email");d(l,this,"¡Email copiado!")}),console.log(`✅ Acerca de ${a} ${s} cargado`)},h=()=>{e(".copy_email").off(),console.log("🧹 Acerca limpiado")};export{h as cleanup,f as init,p as render};

import{j as i}from"./vendor-gzd0YkcT.js";import{v as e,a,l as s,b as c,c as o}from"./wii-CRgEAlpH.js";import{w as d}from"./main-A0ay_Ljm.js";import"./main-BRXeYv3r.js";const p=()=>`
  <div class="acerca_container">
    ...
    <div class="acerca_section">
      ...
      <div class="section_content">
        <p><strong>${a}</strong> es un asistente espiritual inteligente diseñado con <strong>11 módulos neuronales especializados</strong>. Lanzado en ${s}, nace con la misión de ofrecer ayuda espiritual, matemática, emocional y técnica en un solo lugar.</p>
    ...
    <div class="acerca_footer">
      ...
      <div class="footer_info">
        <p>© ${s} ${a}. Hecho con <i class="fas fa-heart"></i> y <i class="fas fa-praying-hands"></i> por ${c}</p>
        <p class="footer_version">Versión actual: <strong>${e}</strong></p>
      </div>
    </div>
  </div>
`,f=()=>{i(".copy_email").on("click",function(){const l=i(this).data("email");d(l,this,"¡Email copiado!")}),console.log(`✅ Acerca de ${a} ${e} cargado`)},h=()=>{i(".copy_email").off(),console.log("🧹 Acerca limpiado")};export{h as cleanup,f as init,p as render};

...
import estilosTerminos from './terminos.css?inline';
import { app, version } from '@wii';
import { year } from '@core/widev/widev.js';
  ...
  <section class="ac_hero tm_hero">
    ...
    <div class="ac_hero_body">
      ...
      <div class="tm_hero_chips">
        ...
        <span class="tm_chip"><i class="fas fa-lock"></i> Secreto Comercial</span>
      </div>
...
export const init = () => {
  ...
  addDocListener('click', '.tm_nav', function (e) {
    e.preventDefault();
    const href = this.getAttribute('href');
    import('@rutas').then(m => m.rutas.navigate(href));
  });

  addDocListener('click', '.tm_index_item', function (e) {
    e.preventDefault();
    const href = this.getAttribute('href');

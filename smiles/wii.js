// INFORMACIÓN DEL APP 
export let id = 'chatwii';
export let app = 'ChatWii';
export let icon = 'fa-comments';
export let titulo = 'ChatWii | Asistente de IA inteligente para Chrome';
export let keywii = 'ia, chatwii, asistente virtual, extension chrome, productividad';
export let descri = 'Asistente inteligente integrado para leer tu pantalla, responder preguntas y ayudarte en tus flujos de trabajo diarios de forma gratuita.';
export let linkweb = 'https://chatwii.web.app';
